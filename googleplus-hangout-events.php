...
//add_action( 'admin_init', 'googleplushangoutevent_settings' );
//function googleplushangoutevent_settings() {
//	register_setting( 'yakadanda_googleplus_hangout_event_settings', 'yakadanda_googleplus_hangout_event_options' );
//}
...
function googleplushangoutevent_register() {
  ...
  wp_register_style( 'googleplushangoutevent-style', GPLUS_HANGOUT_EVENT_URL . '/style.css', false, '0.0.2', 'all' );
