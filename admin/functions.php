...
function googleplushangoutevent_is_page() {
  ...
  if (strpos($url, 'admin.php?page=googleplushangoutevent-all-events') !== false) {
    $response = true;
  }
  if (strpos($url, 'admin.php?page=googleplushangoutevent-settings') !== false) {
    $response = true;
  }
...
function googleplushangoutevent_register_menu_page() {
  add_menu_page('Events', 'Events', 'add_users', 'googleplushangoutevent-all-events', 'googleplushangoutevent_page_all_events', network_home_url('wp-content/plugins/yakadanda-google-hangout-events/images/menu-icon.png'), 918276354);
...
function googleplushangoutevent_section_setup() {
  ...
  $output .= 'd. Fill Authorized Redirect URIs textarea with <code>' . admin_url('admin.php?page=googleplushangoutevent-settings') . '</code><br/>';
  ...
  $output .= 'c. Fill Authorized redirect URI with <code>' . admin_url('admin.php?page=googleplushangoutevent-settings') . '</code><br/>';
