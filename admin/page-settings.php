  ...
  <div class="google-web-starter-kit">
    <form method="post" action="">
      ...
      <div id="preference_tabs">
        <ul>
          <li><a href="#preference-tabs-1">Setup</a></li>
          <li><a href="#preference-tabs-2">Widget</a></li>
        </ul>
        <div id="preference-tabs-1">
          <p>Get your api key, client id, and client secret at <a href="https://cloud.google.com/console" target="_blank" class="cta">Google Cloud Console</a>. For more details see <a id="googleplushangoutevent-help-tab" href="#">Setup section</a> on Help tab above.</p>
            ...
            <tr valign="top">
              ...
              <td><input name="calendar_id" type="text" id="calendar_id" value="<?php echo isset($data['calendar_id']) ? $data['calendar_id'] : null; ?>" class="regular-text" />&nbsp;
                <?php if (get_option('yakadanda_googleplus_hangout_event_access_token')): ?>
                  <strong class="color--green">Connected.</strong>
                <?php else: ?>
                  <strong class="color--red">Not Connected.</strong>
                <?php endif; ?>
        ...
        <div id="preference-tabs-2">
          <table class="form-table">
            ...
            <tr valign="top">
              <th scope="row"><label for="icon_hover"><?php _e('Buttons Hover') ?></label></th>
      ...
      <p class="submit">
        <?php if ( get_option('yakadanda_googleplus_hangout_event_access_token') ): ?>
          ...
          <input id="googleplushangoutevent-logout" class="button--primary" type="button" value="Logout" name="googleplushangoutevent-logout">&nbsp;
        <?php else: ?>
          <input id="submit" class="button--primary" type="submit" value="Save and Connect" name="submit">&nbsp;
        <?php endif; ?>
        <input id="googleplushangoutevent-restore-settings" class="button--primary" type="button" value="Reset" name="googleplushangoutevent-restore-settings">
      </p>
    </form>
  </div>
</div>
