  ...
  <form method="post" action="">
    ...
    <div id="preference_tabs">
      ...
      <div id="preference-tabs-1">
        <p>Get your api key, client id, and client secret at <a href="https://cloud.google.com/console" target="_blank">Google Cloud Console</a>. For more details see <a id="googleplushangoutevent-help-tab" href="#">Setup section</a> on Help tab above.</p>
