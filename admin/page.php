<div id="google-hangout-event" class="wrap">
  ...
  <form method="post" action="<?php echo GPLUS_HANGOUT_EVENT_URL . '/admin/posteddata.php'; ?>">
    <input type="hidden" name="redirectionUrl" id="redirectionUrl" value="<?php echo network_home_url($_SERVER["REQUEST_URI"]); ?>"/>
    <table class="form-table">
      ...
      <tr valign="top">
        <th scope="row"><label for="display"><?php _e('Display') ?></label></th>
        <td>
          <input name="hidden_display" type="hidden" id="hidden_display" value="<?php echo $data['display']; ?>" />
