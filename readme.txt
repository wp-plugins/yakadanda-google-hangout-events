...
* Added extend feature for google+ event
* Moved Google+ events menu on wordpress admin
...
= 0.2.6 =
* Fixed logout feature and reset feature
* Fixed undefined index for timezone
